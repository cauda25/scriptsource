  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      movies.forEach((element) => {
        ...
        // console.log("영화명 : ", element.movieNm);
        // console.log("개봉일 : ", element.openDt);
        // console.log("당일관객수 : ", element.audiCnt);
        // console.log("누적관객수 : ", element.audiAcc);

        str += `<tr>`;
        str += `<td>${element.rank} 위</td>`;
        str += `<td>(`;
        ...
        str += `${rankInten})</td>`;
        str += `<td> ${element.movieNm}</td>`;
        str += `<td> ${element.openDt}</td>`;
        str += `<td> ${element.audiCnt}</td>`;
        str += `<td> ${element.audiAcc}</td>`;
        str += `</tr>`;
      });
